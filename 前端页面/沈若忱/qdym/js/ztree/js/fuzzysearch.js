 ...
 * @returns
 */
function fuzzySearch(zTreeId, searchField, clickBtn,isHighLight, isExpand){
                ...
                $.each(nodesShow, function(n,obj){
                    ...
                    if(pathOfOne && pathOfOne.length>0){
                        ...
                        for(var i=0;i<pathOfOne.length-1;i++){
                            ...
                            zTreeObj.expandNode(pathOfOne[i], isExpand); //expand node
                        }
                    }
                });
    ...
    // });
    /*************将监听input输入事件修改为按钮点击事件触发搜索功能,同时注释掉了搜索完成后输入框自动获取焦点的功能******************/
